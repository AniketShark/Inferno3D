...
void Quaternion::angleAxis(float &angle, Vector3 &axis) const
{
...
void Quaternion::multiply(const Quaternion &q, Quaternion &result) const
{
...
void Quaternion::dot(const Quaternion &q, Quaternion &result)
{
...
bool Quaternion::normalized() const
{
	return equal(norm(),1);
}
...
inline Quaternion Quaternion::operator+(const Quaternion &a, const Quaternion &b)
{
...
inline Quaternion& Quaternion::operator+=(Quaternion &a, const Quaternion &b)
{
	a.w += b.w;
	a.x += b.x;
	a.y += b.y;
